...
class Evaluator:
    ...
    def get_potholes(self, points, kalmaned, gps_time_intervals):
        pothole_ts = self.get_pothole_timespans(points, kalmaned, gps_time_intervals)
        self.raw_potholes = fuser.map_potholes_back_to_real_world(pothole_ts, kalmaned, gps_time_intervals)
        return self.raw_potholes

    def get_pothole_timespans(self, points, kalmaned, gps_time_intervals):
        ...
        potholes, acc_time_windows = self.classify_windows(acc_time, acc_down, kalmaned, gps_time_intervals)
        pothole_ts = fuser.map_potholes_to_timestamp(potholes, acc_time_windows)
        return pothole_ts

    def classify_windows(self, acc_time, acc_down, kalmaned, time_intervals):
    ...
    def evaluate_potholes(self):
        ...
        while True:
            try:
                ...
                print(shp_geom)
                for ln, lt, time, prob in zip(ph['lng'], ph['lat'], ph['time'], ph['probability']):
